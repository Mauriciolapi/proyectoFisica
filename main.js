...
function createArrow(){
    ...
    canvas1.style.opacity = '.2';
    canvas2.style.opacity = '.5';
        ...
        */
        ...
        if(q1Value && q2Value > 0){
            ...
            if(positivo1 > positivo2){
                ...
                resultantAngle = (Math.asin(sinAlpha/eR)*e1) * 180 / Math.PI;

                if(positivo1 > 0 && positivo1 < 90){
                    canvas3.style.transform = `rotate(${resultantAngle}deg)`;
                }
                if(positivo1 > 90 && positivo1 < 180){
                    canvas3.style.transform = `rotate(${resultantAngle+90}deg)`;
                }
                if(positivo1 > 180 && positivo1 < 270){
                    canvas3.style.transform = `rotate(${resultantAngle+180}deg)`;
                }
                if(positivo1 > 270){
                    canvas3.style.transform = `rotate(${resultantAngle+270}deg)`;
                }
            }
            ...
            if(positivo2 > positivo1){
                ...
                sinAlpha = Math.sin(alpha*Math.PI/180);
                eR = Math.sqrt(Math.pow(e1,2) + Math.pow(e2,2) - 2*e1*e2*cosAlpha)
                resultantAngle = (Math.asin(sinAlpha/eR)*e2) * 180 / Math.PI;
